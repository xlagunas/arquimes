...
<div id="backOfficeBody">
	<ul class="nav nav-tabs" id="pestanyes">
		<li class="active"><a href="#Portada">Projectes</a></li>
		<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Edita... <b class="caret"></b></a>
			<ul class="dropdown-menu">
				...
				<li class=""><a class="" href="#Colectiu" data-toggle="dropdown-menu">Colectiu</b></a>
				<li class=""><a class="" href="#Residencial" data-toggle="dropdown-menu">Residencial</b></a>
				<li class=""><a class="" href="#Urbanisme" data-toggle="dropdown-menu">Urbanisme</b></a>
				<li class=""><a class="" href="#EnCurs" data-toggle="dropdown-menu">En Curs</b></a>

				<ul class="dropdown-menu">
				<li class=""><a href="#enCurs" data-toggle="tab">En Curs</a></li>
				</ul>
				</li>
			</ul></li>
	</ul>
