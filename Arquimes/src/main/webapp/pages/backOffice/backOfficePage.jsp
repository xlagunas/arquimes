			...
			<div class="tabbable tabs-left">
			  ...
			  <div class="tab-content">
				...
				<s:if test="section.hasContents">
					...
					<s:textarea id="descCa2" theme="simple" name="content.content.ca_CA" style="width: 292px; height: 392px;background-color: #fff;" value="Text del Contingut"></s:textarea>
				</div>
				...
				<s:if test="section.hasContents">				
					...
					<s:textarea id="descEs2" theme="simple" name="content.content.es_ES" style="width: 292px; height: 392px;background-color: #fff;" value="Texto del Contenido"></s:textarea>
				</div>
				...
				<s:if test="section.hasContents">
					...
					<s:textarea id="descEn2" theme="simple" name="content.content.en_EN" style="width: 292px; height: 392px;background-color: #fff;" value="Text Content"></s:textarea>						
					</div>
				<div class="tab-pane" id="fr1">
				<s:if test="section.hasContents">
					<s:textarea id="headFr2" theme="simple" name="content.header.fr_FR" style="width: 292px; height: 30px;background-color: #fff;" value="titre du le contenu"></s:textarea>
				</s:if>
					<s:textarea id="descFr2" theme="simple" name="content.content.fr_FR" style="width: 292px; height: 392px;background-color: #fff;" value="le contenu du texte"></s:textarea>						
				</div>
			  </div>
			</div>
...
<script type="text/javascript">
	$('#taulaNova > tr').bind('click', function(e){
	    ...
	    callServerMethodJSP(true, false,"${pageContext.request.contextPath}/backOffice/getContent?idContent="
	    		+ $(this).attr('id')+"&idSection="+'<s:property value="section.sectionType"/>'+"&hasContents=1", {}, null,
...
<script type="text/javascript">
	$('#taulaNova > tr').bind('click', function(e){
	    callServerMethodJSP(true, false,"${pageContext.request.contextPath}/backOffice/getContent?idContent="
	    		+ $(this).attr('id')+"&idSection="+'<s:property value="section.sectionType"/>'+"&hasContents=0", {}, null,
				function(status, data) {
					if (status == "success") {
						$('#grup2').hide("slide");
						$('#accordion2').append(data);
...
//var myNicEditor = new nicEditor({buttonList : ['fontSize','bold','italic','underline','strikeThrough'], iconsPath : '${pageContext.request.contextPath}/scripts/nicEditorIcons.gif'}).panelInstance('MyNicPanel3');
//new nicEditor({buttonList : ['fontSize','bold','italic','underline','strikeThrough'], iconsPath : '${pageContext.request.contextPath}/scripts/nicEditorIcons.gif'}).panelInstance('MyNicPanel2');
